require = function() {
    return function r(e, t, n) {
        ...
        for (var i = "function" == typeof require && require, c = 0; c < n.length; c++) o(n[c]);
        return o
    }
}()({
    1: [function(e, t, r) {
    ...
    10: [function(e, t, r) {
        ...
        t.exports = function(e) {
            ...
            }(t = Object(e), o)) ? r : i ? n(t) : "Object" == (c = n(t)) && "function" == typeof t.callee ? "Arguments" : c
        }
    }, {
        "./_cof": 11,
        "./_wks": 64
            ...
            s = function(e, t, r) {
                ...
                for (u in r)
                    if (!(f = !_ && b && b[u] !== undefined) || !a(y, u)) {
                        l = f ? b[u] : r[u];
                        y[u] = p && "function" != typeof b[u] ? r[u] : v && f ? i(l, n) : m && b[u] == l ? function(e) {
        ...
        (r = t.exports = function(e, t, r, l, _) {
            ...
            if (i(m)) {
                for (p = a(e.length); p > g; g++)
                    if ((v = t ? y(c(d = e[g])[0], d[1]) : y(e[g])) === u || v === f) return v
            } else
    ...
    39: [function(e, t, r) {
        ...
        t.exports = Object.create || function create(e, t) {
            var r;
            if (null !== e) {
                a.prototype = n(e);
                r = new a;
    ...
    40: [function(e, t, r) {
        ...
        r.f = e("./_descriptors") ? Object.defineProperty : function defineProperty(e, t, r) {
            n(e);
            t = i(t, !0);
            n(r);
            if (o) try {
    ...
    41: [function(e, t, r) {
        var n = e("./_object-dp"),
            o = e("./_an-object"),
            i = e("./_object-keys");
        t.exports = e("./_descriptors") ? Object.defineProperties : function defineProperties(e, t) {
            o(e);
            for (var r, c = i(t), a = c.length, s = 0; a > s;) n.f(e, r = c[s++], t[r]);
            return e
        }
    }, {
        "./_an-object": 8,
    ...
    42: [function(e, t, r) {
        ...
        t.exports = Object.getPrototypeOf || function(e) {
            e = o(e);
            return n(e, i) ? e[i] : "function" == typeof e.constructor && e instanceof e.constructor ? e.constructor.prototype : e instanceof Object ? c : null
        }
    }, {
        "./_has": 22,
        "./_shared-key": 52,
    ...
    44: [function(e, t, r) {
        var n = e("./_object-keys-internal"),
            o = e("./_enum-bug-keys");
        t.exports = Object.keys || function keys(e) {
            return n(e, o)
        }
    }, {
        "./_enum-bug-keys": 17,
        ...
        t.exports = function(e) {
            return function(t, r) {
                var i, c, a = String(o(t)),
                    s = n(r),
                    u = a.length;
                return s < 0 || s >= u ? e ? "" : undefined : (i = a.charCodeAt(s)) < 55296 || i > 56319 || s + 1 === u || (c = a.charCodeAt(s + 1)) < 56320 || c > 57343 ? e ? a.charAt(s) : i : e ? a.slice(s, s + 2) : c - 56320 + (i - 55296 << 10) + 65536
            }
        }
    }, {
        "./_defined": 14,
    ...
    56: [function(e, t, r) {
        ...
        if (!_ || !p) {
            ...
            if ("process" == e("./_cof")(l)) n = function(e) {
                l.nextTick(c(y, e, 1))
            };
            else if (h && h.now) n = function(e) {
                h.now(c(y, e, 1))
            };
            else if (d) {
                i = (o = new d).port2;
            ...
            } else n = "onreadystatechange" in u("script") ? function(e) {
        ...
        var n, o, i, c, a = e("./_library"),
            ...
            S = !! function() {
                try {
                    ...
                    return (N || "function" == typeof PromiseRejectionEvent) && t.then(P) instanceof r
                } catch (n) {}
            }(),
            q = function(e) {
                var t;
            ...
            O = function(e, t) {
                if (!e._n) {
                    ...
                    var r = e._c;
                    y(function() {
                        for (var n = e._v, o = 1 == e._s, i = 0, c = function(t) {
                                var r, i, c, a = o ? t.ok : t.fail,
                                    s = t.resolve,
                                    u = t.reject,
                                    f = t.domain;
                                try {
                                    if (a) {
                                        ...
                                        r === t.promise ? u(x("Promise-chain cycle")) : (i = q(r)) ? i.call(r, s, u) : s(r)
                                    } else u(n)
                                } catch (l) {
                                    f && !c && f.exit();
                                    u(l)
            ...
            L = function(e) {
                m.call(s, function() {
                    ...
                    if (i) {
                        t = b(function() {
                            N ? j.emit("unhandledRejection", o, e) : (r = s.onunhandledrejection) ? r({
                                promise: e,
                                reason: o
            ...
            R = function(e) {
                m.call(s, function() {
                    var t;
                    N ? j.emit("rejectionHandled", e) : (t = s.onrejectionhandled) && t({
                        promise: e,
                        reason: e._v
                    })
                })
    ...
    75: [function(e, t, r) {
        ! function(e) {
            ...
            if (f) u && (t.exports = f);
                ...
                var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(v);
                GeneratorFunction.prototype = g.constructor = GeneratorFunctionPrototype;
                GeneratorFunctionPrototype.constructor = GeneratorFunction;
                GeneratorFunctionPrototype[s] = GeneratorFunction.displayName = "GeneratorFunction";
                f.isGeneratorFunction = function(e) {
                    var t = "function" == typeof e && e.constructor;
                    return !!t && (t === GeneratorFunction || "GeneratorFunction" === (t.displayName || t.name))
                };
                f.mark = function(e) {
                    if (Object.setPrototypeOf) Object.setPrototypeOf(e, GeneratorFunctionPrototype);
                    else {
    ...
    "babel-runtime/helpers/asyncToGenerator": [function(e, t, r) {
        "use strict";
        r.__esModule = !0;
            ...
            return function() {
                ...
                return new n["default"](function(e, r) {
                    return function step(o, i) {
                        ...
                        if (!c.done) return n["default"].resolve(a).then(function(e) {
                            step("next", e)
                        }, function(e) {
                            step("throw", e)
                        });
    ...
    "babel-runtime/helpers/classCallCheck": [function(e, t, r) {
        "use strict";
        r.__esModule = !0;
    ...
    "babel-runtime/helpers/createClass": [function(e, t, r) {
        "use strict";
        r.__esModule = !0;
        var n = function _interopRequireDefault(e) {
            return e && e.__esModule ? e : {
    ...
    "babel-runtime/regenerator": [function(e, t, r) {
...
var WindowDetector = function() {
    (0, _createClass3["default"])(WindowDetector, null, [{
        key: "get",
        value: function get() {
            WindowDetector._instance || (WindowDetector._instance = new WindowDetector);
...
var Nimiq = function() {
    function Nimiq() {
        ...
        value: function _load(e, t) {
            ...
            Nimiq._loadPromise = Nimiq._loadPromise || new Promise(function(r, n) {
                if (!Nimiq._script) {
                ...
                e || (e = Nimiq._currentScript && -1 !== Nimiq._currentScript.src.indexOf("/") ? Nimiq._currentScript.src.substring(0, Nimiq._currentScript.src.lastIndexOf("/") + 1) : "./");
                Nimiq._path = e;
                ...
                return new Promise(function(e, t) {
                    return Nimiq.WasmHelper.doImportBrowser().then(e)["catch"](t.bind(null, Nimiq.ERR_UNKNOWN))
                })
            });
        ...
        value: function init(e, t) {
            Nimiq._hasNativePromise() && Nimiq._hasNativeGoodies() ? WindowDetector.get().waitForSingleWindow(function() {
                Nimiq.load().then(function() {
