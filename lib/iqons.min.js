(function() {
    ...
    var Iqons = {
        svg: function(t, s = !1) {
            var e = this._hash(t);
            return this._svgTemplate(e[0], e[2], e[3] + e[4], e[5] + e[6], e[7] + e[8], e[9] + e[10], e[11], e[12], s);
        },
        render: function(t, s) {
            s.innerHTML = this.svg(t);
        },
        toDataUrl: function(t) {
            return 'data:image/svg+xml;base64,' + btoa(this.svg(t, !0)).replace(/#/g, "%23");
        },
        placeholder: function(t = "#bbb", s = 1) {
        ...
        renderPlaceholder: function(t, s, e) {
            t.innerHTML = this.placeholder(s, e);
        },
        placeholderToDataUrl: function(t, s) {
            return 'data:image/svg+xml;base64,' + btoa(this.placeholder(t, s));
        },
        image: function(t) {
            var s = this.toDataUrl(t),
                e = this._loadImage(s);
            return e.style.width = "100%", e.style.height = "100%", e;
        },
        _svgTemplate: function(t, s, e, a, n, r, i, c, l) {
            return this._$svg(this._$iqons(t, s, e, a, n, r, i, l), c);
        },
        _$iqons: function(t, s, e, a, n, r, i, c) {
            for (t = parseInt(t), s = parseInt(s), i = parseInt(i), t === s && ++t > 9 && (t = 0); i === t || i === s;) ++i > 9 && (i = 0);
            return t = this.colors[t], s = this.colors[s], '<g color="' + t + '" fill="' + (i = this.colors[i]) + '">\n    <rect fill="' + s + '" x="0" y="0" width="160" height="160"></rect>\n    <circle cx="80" cy="80" r="40" fill="' + t + '"></circle>\n    <g opacity=".1" fill="#010101"><path d="M119.21,80a39.46,39.46,0,0,1-67.13,28.13c10.36,2.33,36,3,49.82-14.28,10.39-12.47,8.31-33.23,4.16-43.26A39.35,39.35,0,0,1,119.21,80Z"/></g>\n    ' + this._generatePart("top", a, c) + '\n    ' + this._generatePart("side", n, c) + '\n    ' + this._generatePart("face", e, c) + '\n    ' + this._generatePart("bottom", r, c) + '\n</g>';
        },
        _$svg: function(t, s) {
            var e = this._getRandomId();
            return '<svg viewBox="0 0 160 160" width="160" height="160" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/2000/xlink" >\n    <defs>\n        <clipPath id="hexagon-clip-' + e + '">\n            <path d="M121.32 22.203l28.588 49.514c2.574 4.455 2.574 9.945 0 14.4L121.32 135.63 c-2.565 4.455-7.322 7.2-12.465 7.2H51.673c-5.144 0-9.9-2.745-12.465-7.2L10.62 86.117c-2.565-4.455-2.565-9.946 0-14.4 l28.593-49.514c2.574-4.455 7.326-7.2 12.465-7.2h57.177C113.998 15.003 118.755 17.748 121.32 22.203z"/>\n        </clipPath>\n    </defs>\n    <path fill="white" stroke="#bbbbbb" transform="translate(0, 8) scale(0.5)" d="M251.6 17.34l63.53 110.03c5.72 9.9 5.72 22.1 0 32L251.6 269.4c-5.7 9.9-16.27 16-27.7 16H96.83c-11.43 0-22-6.1-27.7-16L5.6 159.37c-5.7-9.9-5.7-22.1 0-32L69.14 17.34c5.72-9.9 16.28-16 27.7-16H223.9c11.43 0 22 6.1 27.7 16z"/>\n    <g transform="scale(0.9) translate(9, 8)">\n        <g clip-path="url(#hexagon-clip-' + e + ')">\n            ' + t + '\n        </g>\n    </g>\n</svg>';
        },
        _generatePart: function(t, s, e = !1) {
            if (e) {
                var e = this._getAssets(),
                    a = "#" + t + "_" + this._assetIndex(s, t);
                return e.querySelector(a).innerHTML.replace(/xmlns="[^"]*" ?/g, "");
            }
        ...
        _getAssets: function() {
            if (!this._assets) {
                ...
                r.open("GET", this.svgPath, false);
                r.send(null);
                var m = r.responseText;
                var p = new DOMParser()
                var s = p.parseFromString(m, "text/xml").firstChild;
                this._assets = s;
            }
            return this._assets;
        },
        colors: ["#fb8c00", "#d32f2f", "#fbc02d", "#3949ab", "#03a9f4", "#8e24aa", "#009688", "#f06292", "#7cb342", "#795548"],
        assetCounts: {
        ...
        _assetIndex: function(t, s) {
            return (t = Number(t) % this.assetCounts[s] + 1) < 10 && (t = "0" + t), t;
        },
        _hash: function(t) {
            return ("" + t.split("").map(t => Number(t.charCodeAt(0)) + 3).reduce((t, s) => t * (1 - t) * this.__chaosHash(s), .5)).split("").reduce((t, s) => s + t, "").substr(4, 17);
        },
        __chaosHash: function(t) {
            var s = 1 / t;
            for (var t = 0; t < 100; t++) s = (1 - s) * s * 3.569956786876;
            return s;
        },
